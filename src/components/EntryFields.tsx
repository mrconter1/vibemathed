...
const controlClass =
  "w-full rounded border border-[var(--hairline)] bg-[var(--paper)] px-2.5 py-1.5 text-sm text-[var(--ink)] transition-colors hover:border-[var(--ink-muted)] focus:outline-none focus:ring-1 focus:ring-[var(--accent-blue)]";
