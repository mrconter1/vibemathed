    ...
    >
      ...
      >
        <svg
          ...
          // Not "0 0 24 24". This path's body runs x 2.66 to 22.74 and y 4.0
          // to 19.4, so its centre is (12.70, 11.71) rather than the box's
          // (12, 12): the face leaned 0.7 units right in its tile, and the
          // eyes, drawn at 9.16 and 14.84, were centred on 12 - correct for
          // the box, 0.7 left of the face. Offsetting the viewBox centres the
          // body; the eyes are moved 0.697 right in the path to match.
          viewBox="0.697 -0.29 24 24"
          fill="currentColor"
          aria-hidden
        >
          <path d="M19.27 5.33A16.6 16.6 0 0 0 15.16 4c-.18.32-.39.75-.53 1.09a15.4 15.4 0 0 0-4.26 0C10.23 4.75 10.02 4.32 9.83 4a16.6 16.6 0 0 0-4.11 1.33C3.1 9.26 2.39 13.08 2.74 16.85a16.7 16.7 0 0 0 5.06 2.57c.41-.56.77-1.15 1.08-1.77-.59-.22-1.16-.5-1.69-.82.14-.1.28-.21.41-.32a11.9 11.9 0 0 0 10.2 0c.14.11.27.22.41.32-.54.32-1.11.6-1.7.82.31.62.67 1.21 1.08 1.77a16.6 16.6 0 0 0 5.06-2.57c.42-4.37-.72-8.16-2.38-11.52ZM9.857 14.55c-.99 0-1.8-.9-1.8-2.01 0-1.11.79-2.01 1.8-2.01 1.01 0 1.82.9 1.8 2.01 0 1.11-.8 2.01-1.8 2.01Zm5.68 0c-.99 0-1.8-.9-1.8-2.01 0-1.11.79-2.01 1.8-2.01 1.01 0 1.82.9 1.8 2.01 0 1.11-.79 2.01-1.8 2.01Z" />
        </svg>
      </a>
      <a
        href={X_PROFILE}
